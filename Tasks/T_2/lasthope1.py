...
model = linear_model.LinearRegressionCV(tol=1e-07, penalty="l2", random_state = 42, max_iter= 100)
...
# Takes one third of the input for validation
for i in range(4):
    Xs_train3[i], Xs_test3[i], ys_train3[i], ys_test3[i] = train_test_split(Xs_3[i], ys_3[i], test_size=0.1, random_state=69)
