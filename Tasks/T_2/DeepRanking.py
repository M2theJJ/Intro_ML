...
class DataGenerator(object):
    ...
    def get_train_generator(self, batch_size):
        return self.idg.flow_from_directory("C:/Users/quent/Notebook IntroMl/task4_be9ai3nsdj",
                                            batch_size=batch_size,
                                            target_size=self.target_size,shuffle=False,
                                            triplet_path  ='C:/Users/quent/Notebook IntroMl/task4_be9ai3nsdj/train_tripletsBis.txt'
                                           )
